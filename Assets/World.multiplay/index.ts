...
export default class extends Sandbox {
    ...
    onCreate(options: SandboxOptions) {
        ...
        this.onMessage("onChangedState", (client, message)=>{
            ...
            player.swimmingRatio = message.swimmingRatio;
        });

        // this.onMessage("onChangedGaOhRiTransform", (client, message) => {
        //     const player = this.state.players.get(client.sessionId);
        //     const transform = new Transform();
        ...
        //     console.log(`[Debug] GaOhRi Transform : ${message.position} / ${message.rotation}`);

        //     player.gaohriTransform = transform;
        // });

        this.onMessage("Debug", (client, message) => {
            console.log(`[Debug] debugValue : ${message.debugValue}`);
        });

        // this.onMessage("onSeatChanged", (client, message) => {
        //     const player = this.state.players.get(client.sessionId);

        //     player.isSeated = message.isSeated;
        // });
    }
